...
EVENTBRIDGE_RULE_NAME = os.getenv("EVENTBRIDGE_RULE_NAME", "ham-topic-explorer-refresh")
INGESTION_LAMBDA_NAME = os.getenv("INGESTION_LAMBDA_NAME", LAMBDA_FUNCTION_NAME)
ADMIN_REFRESH_COOLDOWN_SECONDS = _get_int("ADMIN_REFRESH_COOLDOWN_SECONDS", 300)
ADMIN_STATE_KEY = os.getenv("ADMIN_STATE_KEY", "admin/refresh_state.json")
INGESTION_STATE_KEY = os.getenv("INGESTION_STATE_KEY", "admin/ingestion_state.json")
